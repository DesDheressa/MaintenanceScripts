...
gwmi -class win32_OperatingSystem -Computer 'CSHSBIAPP02' | select @{label = 'Server'; e = {$_.PSComputerName}}, @{label = 'LastBootupTime'; e = {$_.converttodatetime($_.lastBootupTime)}};
